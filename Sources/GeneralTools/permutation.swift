...
public class Combinatorix {
    ...
    public static func permutationNoRep(multiset: [String], rArray: inout [String], index: Int = 0, result: inout [[String]]){
    ...
    public static func cardProd(array: [[[String]]]) -> [[String]]{
